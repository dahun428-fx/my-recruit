"""Render smilegate-full-resume.html to PDF via headless Chrome --print-to-pdf.
Edit the HTML/CSS by hand, then re-run to refresh outputs/smilegate-full-resume.pdf.
"""
...
INPUT_HTML = ROOT / "outputs" / "smilegate-full-resume.html"
OUTPUT_PDF = ROOT / "outputs" / "smilegate-full-resume.pdf"
CHROME_CANDIDATES = [
...
def render_pdf(html_path: Path, pdf_path: Path) -> None:
    chrome = find_chrome()
    with tempfile.TemporaryDirectory(prefix="smilegate-chrome-") as user_dir:
