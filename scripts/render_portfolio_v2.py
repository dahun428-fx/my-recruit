"""Render portfolio-v2.html to PDF via headless Chrome --print-to-pdf.
Edit the HTML/CSS by hand, then re-run to refresh outputs/portfolio-v2.pdf.
"""
...
INPUT_HTML = ROOT / "outputs" / "portfolio-v2.html"
OUTPUT_PDF = ROOT / "outputs" / "portfolio-v2.pdf"
CHROME_CANDIDATES = [
...
def render_pdf(html_path: Path, pdf_path: Path) -> None:
    chrome = find_chrome()
    with tempfile.TemporaryDirectory(prefix="portfolio-chrome-") as user_dir:
