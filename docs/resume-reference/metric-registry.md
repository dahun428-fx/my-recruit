...
| --- | --- | --- | --- | --- |
| `metric-ai-poc-users` | 3,493명 규모 PoC 운영 | source_stated | 3,493명 대상 PoC를 운영 | `src-resume-20260624`, `src-eval-2025` |
...
| `metric-qa-time` | 반복 QA 3시간 -> 1시간 | confirmed | 반복 QA 시간을 3시간에서 1시간으로 축소 | `src-resume-20260624`, `src-eval-2026-h1` |
