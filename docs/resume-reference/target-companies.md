...
- 하우스 규칙 예외 (지정양식 사유, 소유자 플랜 승인 2026-08-21): F-02 핵심 성과 섹션·F-03 헤드라인·F-07 섹션 순서 미적용 — GS 지정양식 구조([핵심역량] 등)가 우선. F-08 전면 계층 수치는 [핵심역량]이 유일한 1페이지 스캔 섹션이라 시그니처 지표 위주로 유지.
